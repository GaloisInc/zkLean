...
lemma sll_2_mle_one_chunk_liza[ZKField f] (bv1 bv2 : BitVec 8) (fv1 fv2 : Vector f 8) :
  ...
  bv2[6] = false ->
  bv2[5] = false ->
  (bvoutput = ((bv1.zeroExtend 16) <<< bv2.toNat).zeroExtend 32)
  =
  (foutput = evalSubtable SLL2_16 (Vector.append fv1 fv2)) := by
  unfold SLL2_16
  unfold evalSubtable
