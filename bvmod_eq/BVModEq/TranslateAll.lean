...
| `(tactic| translate_all $[[ $extraSimp,* ]]? $[$b:term]? ) => withMainContext do
 ...
 -- try
  ...
  --  let j :BitVec 255 := BitVec.ofNat 255 (a.toNat % 52435875175126190479447740508185965837690552500527637822603658699938581184513)
  --  have h :j = BitVec.ofNat 255 (a.toNat % 52435875175126190479447740508185965837690552500527637822603658699938581184513) := by rfl
  --  simp [<-h]
...
--- FIX
--barrett/scratch/pertseva/lean_circ_all/1/bvxor/bvxor_6_1_complete_01979.lean:8:9
--/barrett/scratch/pertseva/lean_circ_all/1/bvadd/bvadd_6_1_complete_02171.lean:8:9:
