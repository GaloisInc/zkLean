...
theorem emma_and_32_mle_one_chunk
    (bv1 bv2 : BitVec 32) (fv1 fv2 : Vector FF0 32) :
  ...
  (bvoutput = 1- BVModEq.bool_to_bv 32 bv1[0])
  --(BitVec.getLsb' bv2 0))
  =
  (foutput = evalSubtable VirtualAssertHalfwordAlignment_32 (Vector.append fv1 fv2))
:= by
     unfold VirtualAssertHalfwordAlignment_32
     unfold evalSubtable
